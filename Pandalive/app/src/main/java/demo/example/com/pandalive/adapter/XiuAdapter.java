...
public class XiuAdapter extends RecyclerView.Adapter<XiuAdapter.ViewHolder> {
    private List<MyHome.DataBean.PandaliveBean.ListBean> list;
    private Context mContext;

    public XiuAdapter(List<MyHome.DataBean.PandaliveBean.ListBean> list, Context mContext) {
        this.list = list;
